    ...
    public class SignController : ControllerBase
    {
        ...
        public IActionResult SignByFlowID([FromBody] SingleSignActionBody SingleSignActionInfo)
        {
            ...
            foreach (SignLogDetailEntity thisSignLogDetail in SingleSignActionInfo.SignLogDetailInfo)
            {
                ...
                if (RowUnidArrayString == string.Empty)
                    RowUnidArrayString = currentRowUnid;
                else
                    RowUnidArrayString = RowUnidArrayString + "," + currentRowUnid;


                if (NoteArrayString == string.Empty)
                    NoteArrayString = currentSingRemark;
                else
                    NoteArrayString = NoteArrayString + "," + currentSingRemark;
            }
